      ...
      <div style={{background: '#E3E3E3'}}>
        <CardWrapper>
          <CardHeader>
            ...
            <CardRightContent>
              <EditableLabel placeholder="Time allotted" onChange={val => this.updateField('allotted', val)} />
              <EditableLabel placeholder="Time spent" onChange={val => this.updateField('spent', val)} />
            </CardRightContent>
          </CardHeader>
          <Detail>
